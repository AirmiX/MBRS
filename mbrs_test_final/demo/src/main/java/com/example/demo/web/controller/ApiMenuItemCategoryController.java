...
public class ApiMenuItemCategoryController {
	...
	public ResponseEntity<MenuItemCategoryDTO> add(@RequestBody MenuItemCategoryDTO newMenuItemCategory) {
	...
	public ResponseEntity<MenuItemCategoryDTO> edit(@RequestBody MenuItemCategoryDTO menuItemCategory,
