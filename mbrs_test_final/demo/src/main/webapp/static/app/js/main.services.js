...
demoApp.service('restaurantBrandService', function($http) {
	
	this.url = 'api/restaurantBrandList';
...
demoApp.service('restaurantService', function($http) {
	
	this.url = 'api/restaurantList';
