...
class GenerateAction extends MDAction{
	...
	public void actionPerformed(ActionEvent evt) {
		...
		try {
			...
			// Spring Controller
			GeneratorOptions go6 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("SpringControllerGenerator");			
			...
			GeneratorOptions go8 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("SpringDTOToModelGenerator");			
			...
			GeneratorOptions go9 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("SpringApplicationFileGenerator");			
			...
			GeneratorOptions go12 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("AngularViewEntityPageGenerator");			
			AngularGenerator angularViewEntityPageGenerator = new AngularGenerator(go12);
			angularViewEntityPageGenerator.generate();
			
			GeneratorOptions go13 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("AngularIndexPageGenerator");			
			...
			GeneratorOptions go15 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("AngularServicesGenerator");			
